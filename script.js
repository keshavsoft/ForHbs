...
<td class="ButtonClass">
    <a href="#" class="KMainTableBodyRowDeleteButtonClass">
...
<td class="ButtonClass">
    <a href="#" class="MainTableFooterBodyRowEditClass"
        style="color: forestgreen;">
...
<td class="UpdateClass" style="display: none;">
    <button type="button" class="MainTableFooterBodyRowUpdateClass"
...
{{#if this.Delete.Simple}}
<td class="ButtonClass">
    <button type="button" class="btn btn-circle btn-primary SubTableBodyRowDeleteClass"><svg
...
<div class="row">
    <div class="col-1">
        <a href="{{HrefToSubTableToggles  this.KData.TableInfo.DataAttributes}}"
...
<script id="TableWithSearchOnly/Body/KTablebody"  KS="KeshavSoft" type="text/x-handlebars-template">
{{#each this.KData.TableData as |val key|}}
{{> ReportTableForPrint/Body/Row/NormalFromTableInfo inTableColumns=../KData.TableColumns inTableInfo=../KData.TableInfo this=this}}
{{/each}}

</script>
<script id="TableWithSearchOnly/Body/Row/KTCellValue"  KS="KeshavSoft" type="text/x-handlebars-template">
<td class="KCol-{{@index}}" data-kcol={{@index}}
style="text-align: {{lookup (lookup (lookup (lookup (lookup @root @../../key) 'KData') 'TableColumns') @key) 'TextAlign'}}">
{{#if (lookup (lookup (lookup (lookup (lookup (lookup @root @../../key) 'KData') 'TableColumns') @key) 'DisplayType') 'IsInput') }}
<input ksr2 class="form-control" type="text"
...
<script id="TableWithSearchOnly/Body/Row/NormalFromTableInfo"  KS="KeshavSoft" type="text/x-handlebars-template">
<tr class="KTableRow {{this.RowClass}}" data-klevel="{{Table_KLevel inTableInfo.KLevel}}"
    data-pk="{{array_value_indexret inTableColumns inTableInfo.kPK this.DisplayText}}"
    data-details="{{array_value_indexret inTableColumns inTableInfo.kDetails this.DisplayText}}"
    data-kjsonfilename="{{this.TableKJsonFileName}}">
...
<script id="TableWithSearchOnly/Footer/Show/BalanceRow"  KS="KeshavSoft" type="text/x-handlebars-template">
<tr class="table-info">
    <td style="text-align:right; display:none" class="kClassSearchSNo"></td>
    <td></td>
...
<script id="TableWithSearchOnly/Footer"  KS="KeshavSoft" type="text/x-handlebars-template">
{{#if this.KData.TableInfo.FooterType.ShowTotals}}
<tr ReportTableShowTotals class="table-info">
    <td style="text-align:right; display:none" class="kClassSearchSNo"></td>
    <td>{{this.KData.TableData.length}}</td>
...
<script id="TableWithSearchOnly/Head/KThead"  KS="KeshavSoft" type="text/x-handlebars-template">
<tr>
    <th width="5%" class="kClassSearchSNo" style="cursor:pointer; text-align:right; display:none">#</th>
    <th width="5%" style="cursor:pointer; text-align:right;">#</th>
    {{#each this.KData.TableColumns as |val1 key1|}}
...
<script id="TableWithSearchOnly/KTable"  KS="KeshavSoft" type="text/x-handlebars-template">
<div class="table-responsive">
    <table class=" table KTableClass table-hover">
        <thead>
            {{> TableWithSearchOnly/Head/KThead }}
        </thead>
        <tbody>
            {{> TableWithSearchOnly/Body/KTablebody }}
        </tbody>
        <tfoot>
            {{#if KData.TableInfo.ShowFooter}} {{> TableWithSearchOnly/Footer }} {{/if}}
        </tfoot>
    </table>
</div>
</script>
<script id="TableWithSearchOnly/KTableWithCardAndSearchRow"  KS="KeshavSoft" type="text/x-handlebars-template">
<div id="kcard1" class="card KTableDivClass">
    <div class="card-header">
        {{> TableWithSearchOnly/Search/KSearchRow}}
    </div>
    <div class="card-body">
        {{> TableWithSearchOnly/KTable KGlobalIndex=KGlobalIndex}}
    </div>
</div>
</script>
...
<script id="TableWithSearchOnly/Vertical/KPopUp"  KS="KeshavSoft" type="text/x-handlebars-template">
<div class="card KTableDivClass" data-pk="{{KData.TableInfo.PK}}"
    data-KeyAsTree="{{KData.TableInfo.DataAttributes.KeyAsTree}}"
    data-jsonconfig="{{KData.TableInfo.DataAttributes.JsonConfig}}"
    data-ItemConfig="{{KData.TableInfo.DataAttributes.ItemConfig}}"
